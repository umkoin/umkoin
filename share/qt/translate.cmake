...
function(extract_strings output)
  ...
  file(STRINGS "umkoinstrings.po" text ENCODING "UTF-8")
...
static const char UNUSED *umkoin_strings[] = {
  ...
  set(prefix "QT_TRANSLATE_NOOP(\"umkoin-core\", \"")
  set(suffix "\"),\n")
...
extract_strings("${PROJECT_SOURCE_DIR}/src/qt/umkoinstrings.cpp"
