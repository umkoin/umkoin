...
{
    return AbsPathForConfigVal(fs::path(gArgs.GetArg("-pid", UMKOIN_PID_FILENAME)));
}
...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-conf=<file>", strprintf("Specify configuration file. Relative paths will be prefixed by datadir location. (default: %s)", UMKOIN_CONF_FILENAME), ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
    ...
    gArgs.AddArg("-pid=<file>", strprintf("Specify pid file. Relative paths will be prefixed by a net-specific datadir location. (default: %s)", UMKOIN_PID_FILENAME), ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
    ...
    gArgs.AddArg("-checkpoints", strprintf("Enable rejection of any forks from the known historical chain until block 39332 (default: %u)", DEFAULT_CHECKPOINTS_ENABLED), ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::DEBUG_TEST);
...
std::string LicenseInfo()
{
    ...
    const std::string URL_WEBSITE = "<http://www.umkoin.org>";
...
/** Sanity checks
 *  Ensure that Umkoin is running in a usable environment with all
...
bool AppInitMain(NodeContext& node)
{
    ...
    fs::path config_file_path = GetConfigFile(gArgs.GetArg("-conf", UMKOIN_CONF_FILENAME));
