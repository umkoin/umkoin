...
{
    return AbsPathForConfigVal(fs::PathFromString(args.GetArg("-pid", UMKOIN_PID_FILENAME)));
}
...
void SetupServerArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-conf=<file>", strprintf("Specify path to read-only configuration file. Relative paths will be prefixed by datadir location. (default: %s)", UMKOIN_CONF_FILENAME), ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
...
std::string LicenseInfo()
{
    ...
    return CopyrightHolders(strprintf(_("Copyright (C) %i-%i").translated, 2017, COPYRIGHT_YEAR) + " ") + "\n" +
           "\n" +
