...
#ifndef WIN32
    gArgs.AddArg("-pid=<file>", strprintf(_("Specify pid file. Relative paths will be prefixed by a net-specific datadir location. (default: %s)"), UMKOIN_PID_FILENAME), false, OptionsCategory::OPTIONS);
#endif
