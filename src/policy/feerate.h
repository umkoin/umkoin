...
const std::string CURRENCY_UNIT = "UMK"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    UMK_KVB,      //!< Use UMK/kvB fee rate unit
...
public:
     ...
     *  where 1e5 is the ratio to convert from UMK/kvB to sat/vB.
     *
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::UMK_KVB) const;

    SERIALIZE_METHODS(CFeeRate, obj) { READWRITE(obj.nSatoshisPerK); }
};

#endif //  UMKOIN_POLICY_FEERATE_H
