...
#ifndef UMKOIN_NODE_CONNECTION_TYPES_H
#define UMKOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/umkoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Umkoin’s Peer-to-Peer Network")
...
#endif // UMKOIN_NODE_CONNECTION_TYPES_H
