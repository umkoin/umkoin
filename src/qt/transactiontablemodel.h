...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, UmkoinUnits::SeparatorStyle separators=UmkoinUnits::separatorStandard) const;
