...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, UmkoinUnits::SeparatorStyle separators=UmkoinUnits::SeparatorStyle::STANDARD) const;
...
#endif // UMKOIN_QT_TRANSACTIONTABLEMODEL_H
