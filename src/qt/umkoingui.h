...
public:
    ...
    explicit UmkoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~UmkoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a umkoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, UmkoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Umkoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(UmkoinUnit newUnits);
