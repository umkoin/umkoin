...
<context>
    ...
    <message>
        ...
        <translation>Это ваши умкоин-адреса для отправки платежей. Всегда проверяйте сумму и адрес получателя перед отправкой перевода.</translation>
    </message>
    <message>
...
Signing is only possible with addresses of the type 'legacy'.</source>
        <translation>Это ваши умкоин-адреса для получения платежей. Используйте кнопку «Создать новый адрес для получения» на вкладке Получить, чтобы создать новые адреса.
...
<context>
    ...
    <message>
        ...
        <translation>Предупреждение: если вы зашифруете кошелёк и потеряете парольную фразу, вы &lt;b&gt;ПОТЕРЯЕТЕ ВСЕ ВАШИ УМКОИНЫ&lt;/b&gt;!</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Помните, что шифрование кошелька не может полностью защитить ваши умкоины от кражи вредоносными программами, заражающими ваш компьютер.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Запросить платёж (генерирует QR-коды и URI протокола umkoin:)</translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        ...
        <translation><numerusform>%n активное подключение к сети Umkoin</numerusform><numerusform>%n активных подключения к сети Umkoin</numerusform><numerusform>%n активных подключений к сети Umkoin</numerusform><numerusform>%n активных подключений к сети умкоина</numerusform></translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Загрузить частично подписанные умкоин-транзакции (PSBT)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Загрузить частично подписанную умкоин-транзакцию из буфера обмена</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Открыть URI протокола umkoin:</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введенный адрес "%1" не является действительным умкоин-адресом.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>%1 скачает и сохранит копию цепочки блоков умкоина.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Недавние транзакции могут быть пока не видны, и поэтому отображаемый баланс вашего кошелька может быть неверным. Информация станет верной после завершения синхронизации с сетью умкоина, прогресс которой вы можете видеть ниже.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Открыть URI умкоина</translation>
    </message>
    <message>
        <source>URI:</source>
...
<context>
    ...
    <message>
        ...
        <translation>Автоматически открыть порт умкоин-клиента на маршрутизаторе. Работает, если ваш маршрутизатор поддерживает UPnP, и данная функция включена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключиться к сети умкоина через прокси SOCKS5.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключаться к сети умкоина через отдельный прокси SOCKS5 для скрытых сервисов Tor.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удаётся запустить обработчик click-to-pay для протокола umkoin:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>«umkoin://» — это неверный URI. Используйте вместо него «umkoin:».</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось обработать URI! Это может быть вызвано тем, что умкоин-адрес неверен или параметры URI неправильно сформированы.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Внимание: это сообщение не будет отправлено вместе с платежом через сеть умкоина.</translation>
    </message>
    <message>
...
Примечание: так как комиссия рассчитывается пропорционально размеру в байтах, комиссия «100 сатоши за КБ» для транзакции размером 500 байт (половина 1 КБ) приведет к сбору в размере всего 50 сатоши.</translation>
    ...
    <message>
        ...
        <translation>Создает частично подписанную умкоин-транзакцию (PSBT), чтобы использовать её, например, с офлайновым кошельком %1, или PSBT-совместимым аппаратным кошельком.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Пожалуйста, ещё раз просмотрите черновик вашей транзакции. Будет создана частично подписанная умкойн-транзакцию (PSBT), которую можно сохранить или скопировать, после чего подписать, например, офлайновым кошельком %1, или PSBT-совместимым аппаратным кошельком.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Предупреждение: неверный умкоин-адрес</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Умкоин-адрес, на который нужно отправить платёж</translation>
    </message>
    <message>
        <source>Alt+A</source>
    ...
    <message>
        ...
        <translation>Комиссия будет вычтена из отправляемой суммы. Получателю придёт меньше умкоинов, чем вы ввели в поле «Сумма». Если выбрано несколько получателей, комиссия распределяется поровну.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Сообщение, которое было прикреплено к URI и которое будет сохранено вместе с транзакцией для вашего сведения. Обратите внимание: сообщение не будет отправлено через сеть умкоина.</translation>
    </message>
    <message>
        <source>Pay To:</source>
        <translation>Отправить на:</translation>
...
<context>
    ...
    <message>
        ...
        <translation>Умкоин-адрес, которым подписать сообщение</translation>
    </message>
    <message>
        <source>Choose previously used address</source>
        <translation>Выбрать ранее использованный адрес</translation>
    ...
    <message>
        ...
        <translation>Умкоин-адрес, которым было подписано сообщение</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>%s испорчен. Попробуйте восстановить с помощью инструмента umkoin-wallet или восстановите из резервной копии.</translation>
    </message>
    <message>
