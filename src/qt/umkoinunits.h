...
/** Umkoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class UmkoinUnits: public QAbstractListModel
{
    Q_OBJECT
...
typedef UmkoinUnits::Unit UmkoinUnit;

#endif // UMKOIN_QT_UMKOINUNITS_H
