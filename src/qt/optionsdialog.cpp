      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->umkoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->umkoinAtStartup);
    ...
    ui->umkoinAtStartup->setToolTip(ui->umkoinAtStartup->toolTip().arg(CLIENT_NAME));
    ui->umkoinAtStartup->setText(ui->umkoinAtStartup->text().arg(CLIENT_NAME));

    ui->openUmkoinConfButton->setToolTip(ui->openUmkoinConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new UmkoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->umkoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSUMKontrols);
...
void OptionsDialog::on_openUmkoinConfButton_clicked()
{
