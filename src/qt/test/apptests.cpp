...
//! Entry point for UmkoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &UmkoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for UmkoinGUI tests.
void AppTests::guiTests(UmkoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &UmkoinGUI::consoleShown, this, &AppTests::consoleTests);
