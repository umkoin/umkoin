...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatUmkoinURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + UmkoinUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatUmkoinURI(info));
}
