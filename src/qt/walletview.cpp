...
void WalletView::setUmkoinGUI(UmkoinGUI *gui)
{
    if (gui)
    {
        ...
        connect(overviewPage, &OverviewPage::transactionClicked, gui, &UmkoinGUI::gotoHistoryPage);
        ...
        connect(this, &WalletView::incomingTransaction, gui, &UmkoinGUI::incomingTransaction);

        // Connect HD enabled state signal
        connect(this, &WalletView::hdEnabledStatusChanged, gui, &UmkoinGUI::updateWalletStatus);
    }
}
