...
QT_TRANSLATE_NOOP("umkoin-core", "Attempt to recover private keys from a corrupt wallet on startup"),
QT_TRANSLATE_NOOP("umkoin-core", "Automatically create Tor hidden service (default: %d)"),
...
QT_TRANSLATE_NOOP("umkoin-core", "Connect to a node to retrieve peer addresses, and disconnect"),
QT_TRANSLATE_NOOP("umkoin-core", "Connection options:"),
QT_TRANSLATE_NOOP("umkoin-core", "Copyright (C) %i-%i"),
QT_TRANSLATE_NOOP("umkoin-core", "Corrupted block database detected"),
QT_TRANSLATE_NOOP("umkoin-core", "Debugging/Testing options:"),
QT_TRANSLATE_NOOP("umkoin-core", "Do not load the wallet and disable wallet RPC calls"),
QT_TRANSLATE_NOOP("umkoin-core", "Do you want to rebuild the block database now?"),
QT_TRANSLATE_NOOP("umkoin-core", "Done loading"),
QT_TRANSLATE_NOOP("umkoin-core", "Enable publish hash block in <address>"),
QT_TRANSLATE_NOOP("umkoin-core", "Enable publish hash transaction in <address>"),
...
QT_TRANSLATE_NOOP("umkoin-core", "Error loading %s: You can't disable HD on an already existing HD wallet"),
QT_TRANSLATE_NOOP("umkoin-core", "Error loading block database"),
QT_TRANSLATE_NOOP("umkoin-core", "Error loading wallet %s. -wallet filename must be a regular file."),
QT_TRANSLATE_NOOP("umkoin-core", "Error loading wallet %s. Duplicate -wallet filename specified."),
QT_TRANSLATE_NOOP("umkoin-core", "Error loading wallet %s. Invalid characters in -wallet filename."),
...
QT_TRANSLATE_NOOP("umkoin-core", "Imports blocks from external blk000??.dat file on startup"),
QT_TRANSLATE_NOOP("umkoin-core", "Include IP addresses in debug output (default: %u)"),
...
QT_TRANSLATE_NOOP("umkoin-core", "Invalid amount for -discardfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("umkoin-core", "Invalid amount for -fallbackfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("umkoin-core", "Invalid amount for -paytxfee=<amount>: '%s' (must be at least %s)"),
QT_TRANSLATE_NOOP("umkoin-core", "Invalid netmask specified in -whitelist: '%s'"),
QT_TRANSLATE_NOOP("umkoin-core", "Keep at most <n> unconnectable transactions in memory (default: %u)"),
QT_TRANSLATE_NOOP("umkoin-core", "Keep the transaction memory pool below <n> megabytes (default: %u)"),
QT_TRANSLATE_NOOP("umkoin-core", "Keypool ran out, please call keypoolrefill first"),
QT_TRANSLATE_NOOP("umkoin-core", "Listen for JSON-RPC connections on <port> (default: %u or testnet: %u)"),
QT_TRANSLATE_NOOP("umkoin-core", "Listen for connections on <port> (default: %u or testnet: %u)"),
...
QT_TRANSLATE_NOOP("umkoin-core", "Location of the auth cookie (default: data dir)"),
QT_TRANSLATE_NOOP("umkoin-core", "Maintain at most <n> connections to peers (default: %u)"),
QT_TRANSLATE_NOOP("umkoin-core", "Make the wallet broadcast transactions"),
QT_TRANSLATE_NOOP("umkoin-core", "Maximum per-connection receive buffer, <n>*1000 bytes (default: %u)"),
QT_TRANSLATE_NOOP("umkoin-core", "Maximum per-connection send buffer, <n>*1000 bytes (default: %u)"),
QT_TRANSLATE_NOOP("umkoin-core", "Need to specify a port with -whitebind: '%s'"),
QT_TRANSLATE_NOOP("umkoin-core", "Node relay options:"),
QT_TRANSLATE_NOOP("umkoin-core", "Not enough file descriptors available."),
QT_TRANSLATE_NOOP("umkoin-core", "Only connect to nodes in network <net> (ipv4, ipv6 or onion)"),
QT_TRANSLATE_NOOP("umkoin-core", "Options:"),
QT_TRANSLATE_NOOP("umkoin-core", "Password for JSON-RPC connections"),
QT_TRANSLATE_NOOP("umkoin-core", "Prepend debug output with timestamp (default: %u)"),
QT_TRANSLATE_NOOP("umkoin-core", "Print this help message and exit"),
QT_TRANSLATE_NOOP("umkoin-core", "Print version and exit"),
...
QT_TRANSLATE_NOOP("umkoin-core", "RPC server options:"),
QT_TRANSLATE_NOOP("umkoin-core", "Rebuild chain state and block index from the blk*.dat files on disk"),
QT_TRANSLATE_NOOP("umkoin-core", "Rebuild chain state from the currently indexed blocks"),
QT_TRANSLATE_NOOP("umkoin-core", "Reducing -maxconnections from %d to %d, because of system limitations."),
QT_TRANSLATE_NOOP("umkoin-core", "Relay and mine data carrier transactions (default: %u)"),
QT_TRANSLATE_NOOP("umkoin-core", "Relay non-P2SH multisig (default: %u)"),
QT_TRANSLATE_NOOP("umkoin-core", "Replaying blocks..."),
QT_TRANSLATE_NOOP("umkoin-core", "Rescan the block chain for missing wallet transactions on startup"),
...
QT_TRANSLATE_NOOP("umkoin-core", "Specify pid file (default: %s)"),
QT_TRANSLATE_NOOP("umkoin-core", "Specify wallet file (within data directory)"),
QT_TRANSLATE_NOOP("umkoin-core", "Specify your own public address"),
QT_TRANSLATE_NOOP("umkoin-core", "Spend unconfirmed change when sending transactions (default: %u)"),
...
QT_TRANSLATE_NOOP("umkoin-core", "Threshold for disconnecting misbehaving peers (default: %u)"),
QT_TRANSLATE_NOOP("umkoin-core", "Tor control port password (default: empty)"),
QT_TRANSLATE_NOOP("umkoin-core", "Tor control port to use if onion listening enabled (default: %s)"),
...
QT_TRANSLATE_NOOP("umkoin-core", "Transaction too large for fee policy"),
...
QT_TRANSLATE_NOOP("umkoin-core", "Unsupported argument -debugnet ignored, use -debug=net."),
QT_TRANSLATE_NOOP("umkoin-core", "Unsupported argument -tor found, use -onion."),
QT_TRANSLATE_NOOP("umkoin-core", "Unsupported logging category %s=%s."),
QT_TRANSLATE_NOOP("umkoin-core", "Upgrade wallet to latest format on startup"),
QT_TRANSLATE_NOOP("umkoin-core", "Upgrading UTXO database"),
QT_TRANSLATE_NOOP("umkoin-core", "Use UPnP to map the listening port (default: %u)"),
QT_TRANSLATE_NOOP("umkoin-core", "Use the test chain"),
