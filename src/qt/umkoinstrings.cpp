...
QT_TRANSLATE_NOOP("umkoin-core", "No proxy server specified. Use -proxy=<ip> or -proxy=<ip:port>."),
...
QT_TRANSLATE_NOOP("umkoin-core", "Prune mode is incompatible with -coinstatsindex."),
