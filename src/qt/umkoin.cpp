...
UmkoinApplication::UmkoinApplication(interfaces::Node& node):
...
{
    window = new UmkoinGUI(m_node, platformStyle, networkStyle, nullptr);
...
void UmkoinApplication::createSplashScreen(const NetworkStyle *networkStyle)
{
    ...
    splash->show();
    connect(this, &UmkoinApplication::splashFinished, splash, &SplashScreen::finish);
