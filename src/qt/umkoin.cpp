...
int GuiMain(int argc, char* argv[])
{
    ...
    umksignals::scoped_connection handler_message_box{::uiInterface.ThreadSafeMessageBox.connect(noui_ThreadSafeMessageBox)};
    umksignals::scoped_connection handler_question{::uiInterface.ThreadSafeQuestion.connect(noui_ThreadSafeQuestion)};
    umksignals::scoped_connection handler_init_message{::uiInterface.InitMessage.connect(noui_InitMessage)};
