...
printf("genesis.GenesisBlock = %s\n", genesis. genesis.GenesisBlock().ToString().c_str());
        ...
        assert(genesis.hashMerkleRoot == uint256S("0x1d94e2f2469bda186b6de9ab038bac825117a07350cd8c3f6cb78cf292cf0c55"));
