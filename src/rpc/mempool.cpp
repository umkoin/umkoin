        ...
        "\nRelated RPCs: createrawtransaction, signrawtransactionwithkey\n",
        {
            ...
            {"maxfeerate", RPCArg::Type::AMOUNT, RPCArg::Default{FormatMoney(DEFAULT_MAX_RAW_TX_FEE_RATE.GetFeePerK())},
             "Reject transactions whose fee rate is higher than the specified value, expressed in " + CURRENCY_UNIT +
                 "/kvB.\nFee rates larger than 1UMK/kvB are rejected.\nSet to 0 to accept any fee rate."},
    ...
    return RPCMethod{
        ...
        [](const RPCMethod& self, const JSONRPCRequest& request) -> UniValue
        {
            ...
            if (!peerman.GetInfo().private_broadcast) {
                throw JSONRPCError(RPC_METHOD_NOT_FOUND, "Private broadcast is not enabled. Ensure you're running Umkoin Core with -privatebroadcast=1.");
            }
