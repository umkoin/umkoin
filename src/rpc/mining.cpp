...
static UniValue generatetoaddress(const JSONRPCRequest& request)
{
            ...
            + "If you are running the umkoin core wallet, you can get a new address to send the newly generated umkoin to with:\n"
...
static UniValue generateblock(const JSONRPCRequest& request)
{
    RPCHelpMan{"generateblock",
        ...
        {
            {"address/descriptor", RPCArg::Type::STR, RPCArg::Optional::NO, "The address or descriptor to send the newly generated umkoin to."},
