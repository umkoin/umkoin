...
#include <algorithm>
#include <attributes.h> // Added for Umkoin Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Umkoin Core
#include <util/string.h> // Added for Umkoin Core
...
// Added for Umkoin Core. Similar to std::runtime_format from C++26.
...
// Added for Umkoin Core. Wrapper for checking format strings at compile time.
