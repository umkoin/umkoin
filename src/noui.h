...
#ifndef UMKOIN_NOUI_H
#define UMKOIN_NOUI_H
...
/** Redirect all umkoind signal handlers to LogPrintf. Used to check or suppress output during test runs that produce expected errors */
