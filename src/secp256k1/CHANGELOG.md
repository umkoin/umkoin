...
#### Added
  - Added tests against [Project Wycheproof's](https://github.com/google/wycheproof/) set of ECDSA test vectors (Umkoin "low-S" variant), a fixed set of test cases designed to trigger various edge cases.
...
[unreleased]: https://github.com/umkoin-core/secp256k1/compare/v0.3.2...HEAD
