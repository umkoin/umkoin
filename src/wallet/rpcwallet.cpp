        ...
        HELP_REQUIRING_PASSPHRASE,
            ...
            "       \"" + FeeModes("\"\n\"") + "\""},
                ...
                RPCExamples{
                    ...
                    "\nSend 0.1 UMK with a fee rate of 1 " + CURRENCY_ATOM + "/vB, subtract fee from amount, BIP125-replaceable, using positional arguments\n"
...
static RPCHelpMan send()
{
    return RPCHelpMan{"send",
        ...
        "Send 0.2 UMK with a fee rate of 1 " + CURRENCY_ATOM + "/vB using positional arguments\n"
