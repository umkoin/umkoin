...
static const uint32_t WALLET_UMK_KB_TO_SAT_B = COIN / 1000; // 1 sat / B = 0.00001 UMK / kB
...
static void SetFeeEstimateMode(const CWallet* pwallet, CCoinControl& cc, const UniValue& estimate_mode, const UniValue& estimate_param)
{
    ...
    if (cc.m_fee_mode == FeeEstimateMode::UMK_KB || cc.m_fee_mode == FeeEstimateMode::SAT_B) {
        ...
        if (cc.m_fee_mode == FeeEstimateMode::SAT_B) {
            fee_rate /= WALLET_UMK_KB_TO_SAT_B;
        }
