...
#ifndef UMKOIN_WALLET_SCRIPTPUBKEYMAN_H
#define UMKOIN_WALLET_SCRIPTPUBKEYMAN_H
...
public:
    ...
    /** Birth time changed */
    umksignals::signal<void (const ScriptPubKeyMan* spkm, int64_t new_birth_time)> NotifyFirstKeyTimeChanged;
};
...
#endif // UMKOIN_WALLET_SCRIPTPUBKEYMAN_H
