...
#ifndef UMKOIN_WALLET_WALLETUTIL_H
#define UMKOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! generate automatically new descriptors if it is later encrypted.
    //! To support this behavior, descriptor wallets unlike legacy
    //! wallets do not automatically unset the BLANK flag when things are
    //! imported.
    //!
    //! This flag is also a mandatory flag to prevent previous versions of
    //! umkoin from opening the wallet, thinking it was newly created, and
...
#endif // UMKOIN_WALLET_WALLETUTIL_H
