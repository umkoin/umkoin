...
#ifndef UMKOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define UMKOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@umkoin.
 *
 ...
 *
 * The chacha20-poly1305@umkoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@umkoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@umkoin are relatively fast in
...
#endif // UMKOIN_CRYPTO_CHACHA_POLY_AEAD_H
