...
{
    BOOST_CHECK(TestSplitHost("www.umkoin.org", "www.umkoin.org", 0));
    BOOST_CHECK(TestSplitHost("[www.umkoin.org]", "www.umkoin.org", 0));
    ...
    BOOST_CHECK(TestSplitHost("::6333", "::6333", 0));
    BOOST_CHECK(TestSplitHost(":6333", "", 6333));
    BOOST_CHECK(TestSplitHost("[]:6333", "", 6333));
    ...
    BOOST_CHECK(TestSplitHost("www.umkoin.org:65536", "www.umkoin.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.umkoin.org:0", "www.umkoin.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.umkoin.org:", "www.umkoin.org:", 0, false));
}
