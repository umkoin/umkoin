...
BOOST_AUTO_TEST_CASE(umkk_transaction_tests)
{
    ...
    auto tx_data_2{hex_string_to_byte_vec("")};
...
BOOST_AUTO_TEST_CASE(umkk_script_pubkey)
{
...
BOOST_AUTO_TEST_CASE(umkk_transaction_output)
{
...
BOOST_AUTO_TEST_CASE(umkk_transaction_input)
{
...
BOOST_AUTO_TEST_CASE(umkk_precomputed_txdata) {
    auto tx_data{hex_string_to_byte_vec("")};
    auto tx{Transaction{tx_data}};
    auto tx_data_2{hex_string_to_byte_vec("")};
    auto tx2{Transaction{tx_data_2}};
...
BOOST_AUTO_TEST_CASE(umkk_script_verify_tests)
{
...
{
    umkk_LoggingOptions logging_options = {
        .log_timestamps = true,
...
BOOST_AUTO_TEST_CASE(umkk_context_tests)
{
...
BOOST_AUTO_TEST_CASE(umkk_block_header_tests)
{
    ...
    BlockHeader header_1{hex_string_to_byte_vec("00c00020e7cb7b4de21d26d55bd384017b8bb9333ac3b2b55bed00000000000000000000d91b4484f801b99f03d36b9d26cfa63420b67f81da12d7e6c1e7f364e743c5ba9946e268b4dd011799c8533d")};
...
BOOST_AUTO_TEST_CASE(umkk_block)
{
...
BOOST_AUTO_TEST_CASE(umkk_chainman_tests)
{
    Logger logger{std::make_unique<TestLog>()};
    auto test_directory{TestDirectory{"chainman_test_umkoin_kernel"}};
...
BOOST_AUTO_TEST_CASE(umkk_check_block_context_free)
{
    ...
    BOOST_CHECK_EXCEPTION(Block{truncated_block_data}, std::runtime_error,
                          HasReason{"failed to instantiate umkk object"});
}

BOOST_AUTO_TEST_CASE(umkk_chainman_mainnet_tests)
{
    auto test_directory{TestDirectory{"mainnet_test_umkoin_kernel"}};
...
BOOST_AUTO_TEST_CASE(umkk_block_hash_tests)
{
...
BOOST_AUTO_TEST_CASE(umkk_block_tree_entry_tests)
{
    auto test_directory{TestDirectory{"block_tree_entry_test_umkoin_kernel"}};
    auto notifications{std::make_shared<TestKernelNotifications>()};
...
BOOST_AUTO_TEST_CASE(umkk_chainman_in_memory_tests)
{
    auto in_memory_test_directory{TestDirectory{"in-memory_test_umkoin_kernel"}};
...
BOOST_AUTO_TEST_CASE(umkk_chainman_regtest_tests)
{
    auto test_directory{TestDirectory{"regtest_test_umkoin_kernel"}};
...
// not reachable through umkk_transaction_check.
// -----------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(umkk_transaction_check_tests)
{
    using namespace umkk;
...

    {
        ...
        BOOST_CHECK(umkk_transaction_check(valid_tx.get(), state.get()) == 1);
        BOOST_CHECK(state.GetValidationMode() == ValidationMode::VALID);
        BOOST_CHECK(state.GetTxValidationResult() == TxValidationResult::UNSET);

        BOOST_CHECK(umkk_transaction_check(invalid_tx.get(), state.get()) == 0);
        BOOST_CHECK(state.GetValidationMode() == ValidationMode::INVALID);
