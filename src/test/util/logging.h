...
#ifndef UMKOIN_TEST_UTIL_LOGGING_H
#define UMKOIN_TEST_UTIL_LOGGING_H
...
#define ASSERT_DEBUG_LOG(message) DebugLogHelper UMKOIN_UNIQUE_NAME(debugloghelper)(message)

#endif // UMKOIN_TEST_UTIL_LOGGING_H
