...
BOOST_AUTO_TEST_CASE(addrman_simple)
{
    ...
    vAddr.push_back(CAddress(ResolveService("250.1.1.3", 6333), NODE_NONE));
    vAddr.push_back(CAddress(ResolveService("250.1.1.4", 6333), NODE_NONE));
...
BOOST_AUTO_TEST_CASE(addrman_select)
{
    ...
    BOOST_CHECK(addrman->Add({CAddress(addr5, NODE_NONE)}, ResolveService("250.3.1.1", 6333)));
    BOOST_CHECK(addrman->Good(CAddress(addr5, NODE_NONE)));
    BOOST_CHECK(addrman->Add({CAddress(addr6, NODE_NONE)}, ResolveService("250.3.1.1", 6333)));
...
BOOST_AUTO_TEST_CASE(load_addrman)
{
    ...
    BOOST_CHECK(Lookup("250.7.1.1", addr1, 6333, false));
    ...
    // Add three addresses to new table.
    CService source;
    BOOST_CHECK(Lookup("252.5.1.1", source, 6333, false));
