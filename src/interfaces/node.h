...
#ifndef UMKOIN_INTERFACES_NODE_H
#define UMKOIN_INTERFACES_NODE_H
...
//! Top-level interface for a umkoin node (umkoind process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or umkoin.conf.
...
#endif // UMKOIN_INTERFACES_NODE_H
