...
#ifndef UMKOIN_INTERFACES_INIT_H
#define UMKOIN_INTERFACES_INIT_H
...
//! (umkoin-gui, umkoin-node, umkoin-wallet, umkoind, umkoin-qt) and each
...
#endif // UMKOIN_INTERFACES_INIT_H
