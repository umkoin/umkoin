...
#ifndef UMKOIN_INTERFACES_CHAIN_H
#define UMKOIN_INTERFACES_CHAIN_H
...
//! internal workings of the umkoin node, and not being very convenient to use.
...
#endif // UMKOIN_INTERFACES_CHAIN_H
