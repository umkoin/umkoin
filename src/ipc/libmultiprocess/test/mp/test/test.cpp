...
{
    // Regression test for umkoin/umkoin#34711, umkoin/umkoin#34756 where a
...
{
    // Regression test for umkoin/umkoin#34777 heap-use-after-free where
...
{
    // Regression test for umkoin/umkoin#34782 stack-use-after-return where
