...
#ifndef UMKOIN_IPC_CAPNP_COMMON_TYPES_H
#define UMKOIN_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between umkoin processes.
...
//! Functions to serialize / deserialize common umkoin types.
namespace mp {
...
#endif // UMKOIN_IPC_CAPNP_COMMON_TYPES_H
