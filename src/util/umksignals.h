...
#ifndef UMKOIN_UTIL_UMKSIGNALS_H
#define UMKOIN_UTIL_UMKSIGNALS_H
...
/**
 * umksignals is a simple mechanism for signaling events to multiple subscribers.
...
#endif // UMKOIN_UTIL_UMKSIGNALS_H
