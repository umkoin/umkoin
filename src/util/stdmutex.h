...
#ifndef UMKOIN_UTIL_STDMUTEX_H
#define UMKOIN_UTIL_STDMUTEX_H
...
#define STDLOCK(cs) StdMutex::Guard UMKOIN_UNIQUE_NAME(criticalblock){StdMutex::CheckNotHeld(cs)}

#endif // UMKOIN_UTIL_STDMUTEX_H
