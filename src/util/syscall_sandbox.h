...
#ifndef UMKOIN_UTIL_SYSCALL_SANDBOX_H
#define UMKOIN_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during umkoind initialization if Umkoin Core was compiled
...
#endif // UMKOIN_UTIL_SYSCALL_SANDBOX_H
