...
#ifndef UMKOIN_TXMEMPOOL_H
#define UMKOIN_TXMEMPOOL_H
 ...
 * Umkoin-specific logic. Specifically, TxGraph handles (for each transaction)
 ...
 *
 * CTxMemPool itself handles the Umkoin-specific parts of mempool
