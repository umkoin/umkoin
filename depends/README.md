...
Umkoin Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring Umkoin Core

**When configuring Umkoin Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Umkoin Core:
...
variables will be set when generating the Umkoin Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
