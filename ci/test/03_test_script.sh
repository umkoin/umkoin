...
bash -c "cmake -S $BASE_ROOT_DIR -B ${BASE_BUILD_DIR} $UMKOIN_CONFIG_ALL $UMKOIN_CONFIG" || (
...
if [ "$RUN_UNIT_TESTS_SEQUENTIAL" = "true" ]; then
  DIR_UNIT_TEST_DATA="${DIR_UNIT_TEST_DATA}" LD_LIBRARY_PATH="${DEPENDS_DIR}/${HOST}/lib" "${BASE_BUILD_DIR}"/bin/test_umkoin --catch_system_errors=no -l test_suite
fi
