...
The external dependencies required for the Visual Studio build are (see [dependencies.md](https://github.com/umkoin/umkoin/blob/master/doc/dependencies.md) for more info):
...
Additional dependencies required from the [umkoin](https://github.com/umkoin) GitHub repository are:
- libsecp256k1
- LevelDB
