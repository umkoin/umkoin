...
(`Xcode-12.5-12E262-extracted-SDK-with-libcxx-headers.tar.gz`) can be
extracted from
...
# Unpack Xcode_12.5.xip and place the resulting Xcode.app in your current
# working directory
python3 apple-sdk-tools/extract_xcode.py -f Xcode_12.5.xip | cpio -d -i
```

On macOS the process is more straightforward:

```bash
xip -x Xcode_12.5.xip
```

### Step 2: Generating `Xcode-12.5-12E262-extracted-SDK-with-libcxx-headers.tar.gz` from `Xcode.app`

To generate `Xcode-12.5-12E262-extracted-SDK-with-libcxx-headers.tar.gz`, run
the script [`gen-sdk`](./gen-sdk) with the path to `Xcode.app` (extracted in the
previous stage) as the first argument.

```bash
# Generate a Xcode-12.5-12E262-extracted-SDK-with-libcxx-headers.tar.gz from
