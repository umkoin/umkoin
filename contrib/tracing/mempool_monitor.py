...
""" Example logging Umkoin Core mempool events using the mempool:added,
...
def main(umkoind_path):
    ...
    # to the tracepoints
    umkoind_with_usdts.enable_probe(probe="mempool:added", fn_name="trace_added")
    umkoind_with_usdts.enable_probe(probe="mempool:removed", fn_name="trace_removed")
    umkoind_with_usdts.enable_probe(probe="mempool:replaced", fn_name="trace_replaced")
    umkoind_with_usdts.enable_probe(probe="mempool:rejected", fn_name="trace_rejected")
    bpf = BPF(text=PROGRAM, usdt_contexts=[umkoind_with_usdts])
