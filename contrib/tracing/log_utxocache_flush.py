...
"""Example logging Umkoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/umkoind
...
def main(umkoind_path):
    ...
    b = BPF(text=program, usdt_contexts=[umkoind_with_usdts])
