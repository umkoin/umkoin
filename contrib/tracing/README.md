...
```
$ python3 contrib/tracing/p2p_monitor.py ./build/src/umkoind
```
...
```
$ python3 contrib/tracing/log_raw_p2p_msgs.py ./build/src/umkoind
```
...
```bash
$ python3 contrib/tracing/log_utxocache_flush.py ./build/src/umkoind
```
...
```console
$ python3 contrib/tracing/mempool_monitor.py ./build/src/umkoind
```
