...
* for `src/leveldb`: https://github.com/umkoin-core/leveldb.git (branch umkoin-fork)
* for `src/univalue`: https://github.com/umkoin-core/univalue.git (branch master)
...
A script to optimize png files in the umkoin
