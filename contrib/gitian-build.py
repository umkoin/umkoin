...
def setup():
    ...
    if not os.path.isdir('gitian.sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/umkoin/gitian.sigs.git'])
    if not os.path.isdir('umkoin-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/umkoin/umkoin-detached-sigs.git'])
...
def build():
    ...
    os.makedirs('umkoin-binaries/' + args.version, exist_ok=True)
    ...
    subprocess.check_call(['wget', '-N', '-P', 'inputs', 'https://umkoin.org/cfields/osslsigncode-Backports-to-1.7.1.patch'])
    ...
    if args.windows:
        ...
        subprocess.check_call('mv build/out/umkoin-*-win-unsigned.tar.gz inputs/umkoin-win-unsigned.tar.gz', shell=True)
        subprocess.check_call('mv build/out/umkoin-*.zip build/out/umkoin-*.exe ../umkoin-binaries/'+args.version, shell=True)
    ...
    if args.macos:
        ...
        subprocess.check_call('mv build/out/umkoin-*-osx-unsigned.tar.gz inputs/umkoin-osx-unsigned.tar.gz', shell=True)
        subprocess.check_call('mv build/out/umkoin-*.tar.gz build/out/umkoin-*.dmg ../umkoin-binaries/'+args.version, shell=True)
...
def verify():
    ...
    subprocess.check_call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-linux', '../umkoin/contrib/gitian-descriptors/gitian-linux.yml'])
    print('\nVerifying v'+args.version+' Windows\n')
    subprocess.check_call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-win-unsigned', '../umkoin/contrib/gitian-descriptors/gitian-win.yml'])
    print('\nVerifying v'+args.version+' MacOS\n')
    subprocess.check_call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-osx-unsigned', '../umkoin/contrib/gitian-descriptors/gitian-osx.yml'])
    print('\nVerifying v'+args.version+' Signed Windows\n')
    subprocess.check_call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-win-signed', '../umkoin/contrib/gitian-descriptors/gitian-win-signer.yml'])
    print('\nVerifying v'+args.version+' Signed MacOS\n')
    subprocess.check_call(['bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-osx-signed', '../umkoin/contrib/gitian-descriptors/gitian-osx-signer.yml'])
