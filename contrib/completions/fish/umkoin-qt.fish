...
complete --command umkoin-qt --no-files

# Extract options
function __fish_umkoinqt_get_options
...
complete \
    --command umkoin-qt \
    --arguments "(__fish_umkoinqt_get_options --nofiles)"
