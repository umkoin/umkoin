...
complete --command umkoind --no-files

# Extract options
function __fish_umkoind_get_options
...
complete \
    --command umkoind \
    --arguments "(__fish_umkoind_get_options --nofiles)"
