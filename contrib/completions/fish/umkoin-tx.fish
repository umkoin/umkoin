...
# Extract options
function __fish_umkoin_tx_get_options
...
# Extract commands
function __fish_umkoin_tx_get_commands
...
complete \
    --command umkoin-tx \
    --condition "not __fish_umkoin_seen_cmd (__fish_umkoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_umkoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command umkoin-tx \
    --arguments "(__fish_umkoin_tx_get_commands)" \
    --no-files
