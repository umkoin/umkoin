...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the umkoin repository."
  exit 1
fi
...
BDB_VERSION='db-5.3.21.NC'
BDB_HASH='db4afad0bcb49ed76ac36cc8ded5b1bb893508745a27647c85a858c5d030d5c7'
...
echo
echo 'When compiling umkoind, run `./configure` in the following way:'
echo
