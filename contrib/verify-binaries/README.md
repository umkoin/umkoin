...
As of Umkoin Core v22.0, releases are signed by a number of public keys on the basis
of the [guix.sigs repository](https://github.com/umkoin/guix.sigs/). When
...
builder-keys](https://github.com/umkoin/guix.sigs/tree/main/builder-keys) and
...
threshold of at least 1 trusted signature:
```sh
./contrib/verify-binaries/verify.py \
    --trusted-keys 56E270BDDEDF0118DCAD3B09F15D751647A2C44C \
    --min-good-sigs 1 pub 22.0-linux
```
...
./contrib/verify-binaries/verify.py bin ~/Downloads/SHA256SUMS \
    ~/Downloads/umkoin-24.0.1-x86_64-linux-gnu.tar.gz \
    ~/Downloads/umkoin-24.0.1-arm-linux-gnueabihf.tar.gz
```
