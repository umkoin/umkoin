...
def main():
    ...
    assert v['umkoin-22.0-aarch64-linux-gnu.tar.gz'] == 'd2b2b69917aa2f3389066e637fb38cd18ea8aa51b0b117edc878e600926a005b'
    assert v['umkoin-22.0-osx64.tar.gz'] == '9e3ad3ea0fd71d7e65af3bda5d08702bcc2f3a7919321d9264ecb196b4787e21'
