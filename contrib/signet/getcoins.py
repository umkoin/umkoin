...
def umkoin_cli(rpc_command_and_params):
    argv = [args.cmd] + args.umkoin_cli_args + rpc_command_and_params
    try:
...
if args.faucet.lower() == DEFAULT_GLOBAL_FAUCET:
    ...
    curr_signet_hash = umkoin_cli(['getblockhash', '1'])
...
if args.addr == '':
    ...
    args.addr = umkoin_cli(['getnewaddress', 'faucet', 'bech32'])
