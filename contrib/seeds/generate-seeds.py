...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef UMKOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define UMKOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the umkoin network\n')
    ...
    g.write('#endif // UMKOIN_CHAINPARAMSSEEDS_H\n')
