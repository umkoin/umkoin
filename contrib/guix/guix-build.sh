...
# Deterministically build Umkoin Core
...
INFO: Building commit ${GIT_COMMIT:?not set} for platform triple ${HOST:?not set}:
      ...
      ...from worktree directory: '${PWD}'
          ...bind-mounted in container to: '/umkoin'
...
EOF
        ...
        #     same exact path (e.g. mapping '/home/satoshi/umkoin/' to
        #     '/home/satoshi/umkoin/'). This means that the $PWD inside the
        ...
        #   --share="$PWD"=/umkoin
        #
        #                     maps our current working directory to /umkoin
        ...
        #     container so that we have something to build. '/umkoin' was
        #     chosen arbitrarily.
        #
        ...
        #
        #     When builds of the Guix environment itself (not Umkoin Core)
        ...
        time-machine environment --manifest="${PWD}/contrib/guix/manifest.scm" \
                                 ...
                                 -- env HOST="$host" \
                                        ...
                                        OUTDIR=/outdir \
                                      bash -c "cd /umkoin && bash contrib/guix/libexec/build.sh"
    )
