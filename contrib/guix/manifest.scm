...
(define* (make-umkoin-cross-toolchain target
                                  #:key
...
desirable for building Umkoin Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-umkoin-cross-toolchain "i686-linux-gnu")
       (make-umkoin-cross-toolchain "x86_64-linux-gnu")
       (make-umkoin-cross-toolchain "aarch64-linux-gnu")
       (make-umkoin-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-umkoin-cross-toolchain "riscv64-linux-gnu"
