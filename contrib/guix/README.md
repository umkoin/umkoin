...
To build Umkoin Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Umkoin Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/umkoin-detached-sigs> ./contrib/guix/guix-codesign
```
...
* _**SDK_PATH**_
  ...
  `$HOME/Downloads/macOS-SDKs/Xcode-12.2-15C500b-extracted-SDK-with-libcxx-headers`).
