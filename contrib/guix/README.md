# Bootstrappable Umkoin Core Builds

This directory contains the files necessary to perform bootstrappable Umkoin
Core builds.
...
- 24GB of free disk space on the partition that the Umkoin Core git repository
  resides in
...
For a Umkoin Core depends development environment, simply invoke
...
From the top of a clean Umkoin Core repository:
...
To use dongcarl's substitute server for Umkoin Core builds after having
