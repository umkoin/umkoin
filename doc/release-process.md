...
* Update umkoin.conf and commit changes if they exist, see [gen-bitcoin-conf.sh](https://github.com/umkoin/umkoin/blob/master/contrib/devtools/README.md#gen-bitcoin-confsh).
