...
* Update translations (ping wumpus on IRC) see [translation_process.md](https://github.com/vmta/umkoin/blob/master/doc/translation_process.md#synchronising-translations).

* Update manpages, see [gen-manpages.sh](https://github.com/vmta/umkoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
### Fetch and create inputs: (first time, or when dependency versions change)
    ...
    pushd ./gitian-builder
    mkdir -p inputs
    wget -P inputs https://umkoincore.org/cfields/osslsigncode-Backports-to-1.7.1.patch
...
- Detached signatures will then be committed to the [umkoin-detached-sigs](https://github.com/umkoin-core/umkoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Umkoin Core announcements list https://umkoincore.org/en/list/announcements/join/

  - umkoincore.org blog post
  ...
  - Create a [new GitHub release](https://github.com/vmta/umkoin/releases/new) with a link to the archived release notes.
