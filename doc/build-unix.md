...
Note
---------------------
Always use absolute paths to configure and compile Umkoin Core and the dependencies.
...
To build Umkoin Core without wallet, see [*Disable-wallet mode*](/doc/build-unix.md#disable-wallet-mode)
...
Security
--------
To help make your Umkoin Core installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, Umkoin Core should be built with a non-executable stack,
