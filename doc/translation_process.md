...
See the [Transifex Umkoin project](https://www.transifex.com/projects/p/umkoin/) to assist in translations. You should also join the translation mailing list for announcements - see details below.
...
You can find the Umkoin translation project at [https://www.transifex.com/projects/p/umkoin/](https://www.transifex.com/projects/p/umkoin/).
...
2. Update `src/qt/umkoin_locale.qrc` manually or via
   `ls src/qt/locale/*ts|xargs -n1 basename|sed 's/\(umkoin_\(.*\)\).ts/<file alias="\2">locale\/\1.qm<\/file>/'`
3. Update `src/Makefile.qt.include` manually or via
   `ls src/qt/locale/*ts|xargs -n1 basename|sed 's/\(umkoin_\(.*\)\).ts/  qt\/locale\/\1.ts \\/'`
...
The Umkoin-Core translation maintainers include *tcatm, seone, Diapolo, wumpus and luke-jr*. You can find them, and others, in the Freenode IRC chatroom - `irc.freenode.net #umkoin-core-dev`.
