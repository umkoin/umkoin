...
fungibility of all umkoins. Spenders will enjoy lower fees and the
...
The addition of taproot-related features to Umkoin Core's wallet is
...
- Popular articles;
  - [Taproot Is Coming: What It Is, and How It Will Benefit Umkoin](https://umkoinmagazine.com/technical/taproot-coming-what-it-and-how-it-will-benefit-umkoin)
  - [What do Schnorr Signatures Mean for Umkoin?](https://academy.binance.com/en/articles/what-do-schnorr-signatures-mean-for-umkoin)
...
- Development history overview
  - [Taproot](https://umkoinops.org/en/topics/taproot/)
  - [Schnorr signatures](https://umkoinops.org/en/topics/schnorr-signatures/)
  - [Tapscript](https://umkoinops.org/en/topics/tapscript/)
  - [Soft fork activation](https://umkoinops.org/en/topics/soft-fork-activation/)
