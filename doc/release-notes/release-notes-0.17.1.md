Umkoin Core version 0.17.1 is now available from:

  <http://www.umkoin.org/bin/umkoin-core-0.17.1/>
...
When umkoin is configured with the `-deprecatedrpc=accounts` setting, specifying
...
- #14698 `ec71f06` Add umkoin-tx.exe into Windows installer (ken2812221)
