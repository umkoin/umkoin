Umkoin Core version 0.9.2.1 is now available from:

  https://umkoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 UMK to 0.01 UMK
...
- Fix "Start umkoin on system login"
