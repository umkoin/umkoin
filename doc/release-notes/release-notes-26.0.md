...
Umkoin Core version 26.0 is now available from:
  ...
  <http://www.umkoin.org/bin/umkoin-core-26.0/>
...
- The usage of hybrid public keys in output descriptors has been removed. Hybrid
  ...
  (as specified in BIP380 and documented in doc/descriptors.md). Umkoin Core would
...
- Bash completion files have been renamed from `umkoin*.bash-completion` to
  `umkoin*.bash`. This means completions can be automatically loaded on demand
