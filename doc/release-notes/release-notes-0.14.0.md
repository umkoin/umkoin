...
Umkoin Core has supported automatically pruning the blockchain since 0.11. Pruning
...
When Umkoin Core is out-of-sync on startup, a semi-transparent information
...
The Alert System was [disabled and deprecated](https://bitcoin.org/en/alert/2016-11-01-alert-retirement) in Umkoin Core 0.12.1 and removed in 0.13.0. 
...
- #7562 `1eef038` Bump transaction version default to 2 (umkdrak)
...
- #8608 `7e9ab95` Install manpages via make install, also add some autogenerated manpages (nomnomumk)
...
- #8568 `078900d` new var `DIST_CONTRIB` adds useful things for packagers from contrib (nomnomumk)
...
- #9206 `e662d28` Make test constant consistent with consensus.h (umkdrak)
...
- #9865 `289204f` Change umkoin address in RPC help message (marijnfs)
