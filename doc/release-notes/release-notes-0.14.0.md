Umkoin Core version 0.14.0 is now available from:
  ...
  <https://umkoin.org/bin/umkoin-core-0.14.0/>
...
The Alert System was [disabled and deprecated](https://umkoin.org/en/alert/2016-11-01-alert-retirement) in Umkoin Core 0.12.1 and removed in 0.13.0. 
...
### Documentation
- #6332 `806b9e7` Clarify witness branches in transaction.h serialization (dcousens)
