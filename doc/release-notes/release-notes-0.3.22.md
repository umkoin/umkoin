Download URL: https://sourceforge.net/projects/umkoin/files/Umkoin/umkoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 UMK fee schedule (users still pay 0.01 UMK per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #umkoin00 - #umkoin99
