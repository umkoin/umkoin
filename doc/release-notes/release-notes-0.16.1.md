Umkoin Core version 0.16.1 is now available from:

  <http://www.umkoin.org/bin/umkoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting umkoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure umkoind processes are cleaned up when tests end (sdaftuar)
