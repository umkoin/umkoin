...
Umkoin Core version 0.19.1 is now available from:

  <http://www.umkoin.org/bin/umkoin-core-0.19.1/>
...
- #17488 fix "umkoind already running" warnings on macOS (fanquake)
