Umkoin Core version 28.0 is now available from:

  <http://www.umkoin.org/bin/umkoin-core-28.0/>
...
See [JSON-RPC-interface.md](https://github.com/umkoin/umkoin/blob/master/doc/JSON-RPC-interface.md#json-rpc-11-vs-20) for details. (#27101)
...
libumkoinconsensus Removal
---------------------------

The libumkoin-consensus library was deprecated in 27.0 and is now completely removed. (#29648)
...
- The `warnings` field in `getblockchaininfo`, `getmininginfo` and
  ...
  can be temporarily restored by running Umkoin Core with the configuration
...
are now required to compile Umkoin Core. (#29091, #30263)
...
- A new `-testdatadir` option has been added to `test_umkoin` to allow specifying the
