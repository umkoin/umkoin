...
Umkoin Core version 22.0 is now available from:
  ...
  <http://www.umkoin.org/bin/bitcoin-core-22.0/>
...
- bitcoin-core/gui#21 Improve pruning tooltip (fluffypony, UmkoinErrorLog)
...
- bitcoin-core/gui#361 Fix GUI segfault caused by umkoin/umkoin#22216 (ryanofsky)
...
- bitcoin-core/gui#406 Handle new added plurals in `umkoin_en.ts` (hebasto)
...
[Transifex](https://www.transifex.com/umkoin/bitcoin-core/).
