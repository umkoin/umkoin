Umkoin Core version 0.10.4 is now available from:

  <https://bitcoin.org/bin/umkoin-core-0.10.4/>
...
- #6953 `43c2789` Split umkoin-tx into its own package
- #6953 `dfe0d4d` Include umkoin-tx binary on Debian/Ubuntu
