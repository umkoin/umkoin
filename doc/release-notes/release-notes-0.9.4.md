Umkoin Core version 0.9.4 is now available from:

  https://umkoin.org/bin/0.9.4/
...
this update is incompatible with the Umkoin system and could lead to consensus
forks.

Umkoin Core released binaries from https://umkoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~umkoin/+archive/ubuntu/umkoin
- A third-party or self-compiled Umkoin Core

upgrade to Umkoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
