...
- A new `-asmap` configuration option has been added to diversify the
  ...
  `umkoind help` for more information.  This option is experimental and
...
- For watch-only wallets, creating a new transaction in the Send screen
  ...
  program such as [HWI](https://github.com/umkoin/HWI) for
...
- Umkoin Core's automatically-generated source code documentation is
