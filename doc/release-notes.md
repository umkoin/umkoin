...
See [JSON-RPC-interface.md](https://github.com/umkoin/umkoin/blob/master/doc/JSON-RPC-interface.md#json-rpc-11-vs-20) for details.
...
are now required to compile Umkoin Core.
...
- `-testdatadir` is added to `test_umkoin` to allow specifying the location for unit test data directories.
