...
Umkoin Core version 0.19.2 is now available from:

  <http://www.umkoin.org/bin/umkoin-core-0.19.2/>
...
- #20175 ci: Bump vcpkg commit id to get new msys mirror list (sipsorcery)
