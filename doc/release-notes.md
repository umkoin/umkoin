Umkoin Core version 27.0 is now available from:

  <http://www.umkoin.org/bin/umkoin-core-27.0/>
...
- libumkoinconsensus is deprecated and will be removed for v28. This library has
...
- A C++20 capable compiler is now required to build Umkoin Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Umkoin Core would
