...
#### Removal of reject network messages from Umkoin Core (BIP61)
...
- `testmempoolaccept` and `sendrawtransaction` no longer return the P2P REJECT
  ...
  _Removal of reject network messages from Umkoin Core (BIP61)_ for details on
...
- A new `-asmap` configuration option has been added to enable IP-to-ASN mapping
  ...
  #16702](https://github.com/bitcoin/bitcoin/pull/16702), and the `umkoind
