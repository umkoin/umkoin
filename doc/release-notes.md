...
Umkoin Core version 31.0 is now available from:

  <http://www.umkoin.org/bin/umkoin-core-31.0/>
...
`-dbcache=450`. See
[reduce-memory.md](https://github.com/umkoin/umkoin/blob/master/doc/reduce-memory.md)
...
[doc/policy/mempool-terminology.md](https://github.com/umkoin/umkoin/blob/master/doc/policy/mempool-terminology.md)
and
[doc/policy/mempool-replacements.md](https://github.com/umkoin/umkoin/blob/master/doc/policy/mempool-replacements.md).
...
being deprecated in Umkoin Core 30.0. They used to allow the user to set a
...
The Umkoin Core fee estimator minimum fee rate bucket was updated from **1
