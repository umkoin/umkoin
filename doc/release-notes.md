Umkoin Core version 29.1rc2 is now available from:

  <http://www.umkoin.org/bin/umkoin-core-29.1/test.rc2/>
...
- #32679 doc: update tor docs to use umkoind binary from path
...
- #32719 doc, windows: CompanyName "Umkoin" => "Umkoin Core project"
