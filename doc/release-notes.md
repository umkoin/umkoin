...
- The `connections` field of `umkoin-cli -getinfo` is expanded to return a JSON
...
Default Wallet created upon first startup of Umkoin Core will be a Legacy Wallet.
