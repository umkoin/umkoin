...
Umkoin Core version 24.0.1 is now available from:

  <http://www.umkoin.org/bin/bitcoin-core-24.0.1/>
...
This version of Umkoin Core adds a new `mempoolfullrbf` configuration
...
Some Umkoin services today expect that the first version of an
...
The Umkoin Protocol does not, and cannot, provide any assurance that
...
fees, was realized in [Umkoin Core 0.12.0][] (February 2016) with the
...
default for years, and several contributors to Umkoin Core are
...
- To help prevent fingerprinting transactions created by the Umkoin Core wallet, change output
