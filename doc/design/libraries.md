...
| *libumkoin_ipc*         | IPC functionality used by *umkoin-node* and *umkoin-gui* executables to communicate when [`-DENABLE_IPC=ON`](multiprocess.md) is used. |
