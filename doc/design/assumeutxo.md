...
Assumeutxo is a feature that allows fast bootstrapping of a validating umkoind
...
considered active. This is the "traditional" mode of operation for umkoind.
...
**Failure consideration:** if umkoind unexpectedly halts after `m_stop_use` is set on
...
### Umkoind restarts sometime after snapshot validation has completed

When umkoind initializes again, what began as the snapshot chainstate is now
