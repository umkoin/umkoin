...
with certain assembly code from Umkoin Core's code. See [developer notes on sanitizers](https://github.com/umkoin/umkoin/blob/master/doc/developer-notes.md#sanitizers)
