...
## 2. Manually create a Umkoin Core onion service
...
## 3. Automatically create a Umkoin Core onion service
...
Umkoin Core automatically creates an onion service to listen on. This will positively
...
- Do not add anything but Umkoin Core ports to the onion service created in section 2.
