...
However, in open source software such as Umkoin Core, where everyone uses
...
- Use include guards to avoid the problem of double inclusion. The header file
  `foo/bar.h` should use the include guard identifier `UMKOIN_FOO_BAR_H`, e.g.

```c++
#ifndef UMKOIN_FOO_BAR_H
#define UMKOIN_FOO_BAR_H
...
#endif // UMKOIN_FOO_BAR_H
```
