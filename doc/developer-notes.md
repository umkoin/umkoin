...
Umkoin Core uses [Doxygen](http://www.doxygen.nl/) to generate its official documentation.
...
Some of these are maintained by active developers of Umkoin Core, in which case changes should probably go
directly upstream without being PRed directly against the project. They will be merged back in the next
subtree merge.

Others are external projects without a tight relationship with our project. Changes to these should also
be sent upstream, but bugfixes may also be prudent to PR against Umkoin Core so that they can be integrated
...
- [scripted-diff: Remove g_connman, g_banman globals](https://github.com/umkoin/umkoin/commit/301bd41a2e6765b185bd55f4c541f9e27aeea29d)
