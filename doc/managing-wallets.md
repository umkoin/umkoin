...
```
$ umkoin-cli -named createwallet wallet_name="wallet-01" descriptors=true
```
...
```
$ umkoin-cli -named createwallet wallet_name="wallet-01" descriptors=true passphrase="passphrase"
```
