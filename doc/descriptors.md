# Support for Output Descriptors in Umkoin Core

Since Umkoin Core v0.17, there is support for Output Descriptors. This is a
...
Umkoin Core v24 extended `wsh()` output descriptor with [Miniscript](https://bitcoin.sipa.be/miniscript/) support (initially watch-only). Signing support for Miniscript descriptors was added in v25. And since v26 Miniscript expressions can now be used in Taproot descriptors.
...
- `wsh(multi(2,03a0434d9e47f3c86235477c7b1ae6ae5d3442d49b1943c2b752a68e2a47e247c7,03774ae7f858a9411e5ef4246b70c65aac5649980be5c17891bbec17895da008cb,03d01115d548e7561b15c38f004d734633687cf4419620175bc5b0f47070afe85a))` describes a P2WSH *2-of-3* multisig output with keys in the specified order.
...
on Umkoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
transactions related to the multisig. Lastly, it is not recommended to use anything other than a Umkoin Core descriptor wallet to serve as your
...
existing Umkoin Core wallets, a convenience function `combo` is
...
All RPCs in Umkoin Core will include the checksum in their output. Only
