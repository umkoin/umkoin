...
class BIP66Test(UmkoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # umkoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and umkoind produces more specific reject
            # reasons.
