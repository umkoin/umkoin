...
* Get one successful connection to a Tor peer (.onion) so that umkoind assumes the configured
...
class P2PPrivateBroadcastRetryV1(UmkoinTestFramework):
    ...
    def run_test(self):
        ...
        # The destinations behind the -proxy= don't actually support v2. When umkoind runs with -v2transport=1
        ...
        self.log.info("Opening a connection to a Tor addresses, so umkoind considers -onion= is a real Tor proxy")
