...
# Fee rates (in UMK per 1000 vbytes)
...
class BumpFeeTest(UmkoinTestFramework):
    ...
    def run_test(self):
        ...
        # fund rbf node with 10 coins of 0.001 umk (100,000 satoshis)
        ...
        for mode in ["default", "fee_rate", UMK_MODE, SAT_MODE]:
    ...
    def test_invalid_parameters(self, rbf_node, peer_node, dest_address):
        ...
        for options in [{"fee_rate": INSUFFICIENT}, {"conf_target": INSUFFICIENT, "estimate_mode": UMK_MODE}, {"conf_target": 1, "estimate_mode": SAT_MODE}]:
        ...
        for unit, fee_rate in {"SAT/B": 100, "UMK/KB": NORMAL}.items():
        ...
        for field in ["confTarget", "conf_target"]:
            assert_raises_rpc_error(-4, "is too high (cannot be higher than -maxtxfee",
                                    lambda: rbf_node.bumpfee(rbfid, {"estimate_mode": UMK_MODE, "conf_target": 2017}))
            assert_raises_rpc_error(-4, "is too high (cannot be higher than -maxtxfee",
                                    lambda: rbf_node.bumpfee(rbfid, {"estimate_mode": SAT_MODE, "conf_target": 2017 * 10000}))
        ...
        for mode in ["unset", "economical", "conservative", UMK_MODE, SAT_MODE]:
            ...
            for k, v in {"string": "", "object": {"foo": "bar"}}.items():
                ...
                assert_raises_rpc_error(-8, "Invalid fee_rate 0.00000000 UMK/kB (must be greater than 0)",
...
def test_simple_bumpfee_succeeds(self, mode, rbf_node, peer_node, dest_address):
    ...
    if mode == "fee_rate":
        ...
        bumped_psbt = rbf_node.psbtbumpfee(rbfid, {"conf_target": NORMAL, "estimate_mode": UMK_MODE})
        bumped_tx = rbf_node.bumpfee(rbfid, {"conf_target": NORMAL, "estimate_mode": UMK_MODE})
    elif mode == SAT_MODE:
        sat_fee = NORMAL * COIN / 1000  # convert NORMAL from UMK/kB to sat/B
...
def test_dust_to_fee(self, rbf_node, dest_address):
    ...
    # The DER formatting used by Umkoin to serialize ECDSA signatures means that signatures can have a
    ...
    # Bump with fee_rate of 0.00350250 UMK per 1000 vbytes to create dust.
    # Expected fee is 141 vbytes * fee_rate 0.00350250 UMK / 1000 vbytes = 0.00049385 UMK.
    # or occasionally 140 vbytes * fee_rate 0.00350250 UMK / 1000 vbytes = 0.00049035 UMK.
    # Dust should be dropped to the fee, so actual bump fee is 0.00050000 UMK.
...
def test_maxtxfee_fails(self, rbf_node, dest_address):
    ...
    # expected bump fee of 141 vbytes * 0.00200000 UMK / 1000 vbytes = 0.00002820 UMK
