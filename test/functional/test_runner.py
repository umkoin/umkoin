...
`test/functional/test_framework/test_framework.py:UmkoinTestFramework.main`.
...
def main():
    ...
    tmpdir = "%s/umkoin_test_runner_%s" % (args.tmpdirprefix, datetime.datetime.now().strftime("%Y%m%d_%H%M%S"))
    os.makedirs(tmpdir)
    ...
    if config["environment"]["EXEEXT"] == ".exe" and not args.force:
        # https://github.com/vmta/umkoin/commit/d52802551752140cf41f0d9a225a43e84404d3e9
        # https://github.com/vmta/umkoin/pull/5677#issuecomment-136646964
...
class TestHandler:
    ...
    def __init__(self, num_tests_parallel, tests_dir, tmpdir, test_list=None, flags=None):
        ...
        self.flags = flags
        self.num_running = 0
        # In case there is a graveyard of zombie umkoinds, we can apply a
...
class RPCCoverage():
    ...
    commands per `umkoin-cli help` (`rpc_interface.txt`).
