...
class BIP68Test(UmkoinTestFramework):
    ...
    def activateCSV(self):
        # activation should happen at block height 0
        # getblockchaininfo will show CSV as active at block 0 since it's returning whether CSV is active for the next block.
