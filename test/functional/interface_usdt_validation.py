...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/umkoin/umkoin/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(UmkoinTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/umkoin/umkoin/blob/master/doc/tracing.md#tracepoint-validationblock_connected
        ...
        ctx = USDT(path=str(self.options.umkoind))
