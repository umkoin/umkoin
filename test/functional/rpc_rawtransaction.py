...
class RawTransactionsTest(UmkoinTestFramework):
    ...
    def run_test(self):
        ...
        # 10000 sat fee, ~100 b transaction, fee rate should land around 100 sat/b = 0.00100000 UMK/kB
        ...
        rawTxSigned = self.nodes[2].signrawtransactionwithwallet(rawTx)
        assert_equal(rawTxSigned['complete'], True)
        # 2000000 sat fee, ~100 b transaction, fee rate should land around 20000 sat/b = 0.20000000 UMK/kB
        # Thus, testmempoolaccept should reject
