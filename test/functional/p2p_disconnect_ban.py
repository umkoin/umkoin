...
class DisconnectBanTest(UmkoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[1].setban("127.0.0.0/24", "add")
        self.nodes[1].setban("klfchu53kxun6zx5.onion", "add")
        ...
        for ban in self.nodes[1].listbanned():
            if ban["address"] in ["127.0.0.0/32", "127.0.0.0/24", "klfchu53kxun6zx5.onion"]:
        ...
        assert_equal("klfchu53kxun6zx5.onion", listAfterShutdown[4]['address'])
