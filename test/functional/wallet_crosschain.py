...
class WalletCrossChain(UmkoinTestFramework):
    ...
    def setup_network(self):
        ...
        with open(self.nodes[1].umkoinconf, 'r', encoding='utf8') as conf:
            conf_data = conf.read()
        with open (self.nodes[1].umkoinconf, 'w', encoding='utf8') as conf:
