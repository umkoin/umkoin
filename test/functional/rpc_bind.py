...
"""Test running umkoind with the -rpcbind and -rpcallowip options."""
...
class RPCBindTest(UmkoinTestFramework):
    ...
    def run_test(self):
        ...
        if not self.options.run_nonloopback:
            ...
            if self.options.run_ipv4:
                self.run_invalid_bind_test(['127.0.0.1'], ['127.0.0.1:notaport', '127.0.0.1:-16443', '127.0.0.1:0', '127.0.0.1:65536'])
            if self.options.run_ipv6:
                self.run_invalid_bind_test(['[::1]'], ['[::1]:notaport', '[::1]:-16443', '[::1]:0', '[::1]:65536'])
