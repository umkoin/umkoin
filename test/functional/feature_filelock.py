...
"""Check that it's not possible to start a second umkoind instance using the same datadir or wallet."""
import random
import string
...
class FilelockTest(UmkoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Check that we can't start a second umkoind instance using the same datadir")
        ...
        self.log.info("Check that we can't start a second umkoind instance using the same blocksdir")
        ...
        self.log.info("Check that cookie and PID file are not deleted when attempting to start a second umkoind using the same datadir/blocksdir")
        ...
        if self.is_wallet_compiled():
            ...
            self.log.info("Check that we can't start a second umkoind instance using the same wallet")
