...
class TestUmkoinIpcCli(UmkoinTestFramework):
    ...
    def test_cli(self, args, error=None):
        ...
        args = [self.binary_paths.umkoincli, f"-datadir={self.nodes[0].datadir_path}", "-rpcpassword=wrong"] + args + ["echo", "foo"]
...
if __name__ == '__main__':
    TestUmkoinIpcCli(__file__).main()
