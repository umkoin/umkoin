...
class ConfArgsTest(UmkoinTestFramework):
    ...
    def test_negated_config(self):
        ...
        ignored_file_message = [f'[InitConfig] Data directory "{self.nodes[0].datadir_path}" contains a "umkoin.conf" file which is explicitly ignored using -noconf.']
    ...
    def test_config_file_parser(self):
        ...
        with open(self.nodes[0].datadir_path / 'umkoin.conf', 'a', encoding='utf-8') as conf:
