...
class FullBlockTest(UmkoinTestFramework):
    ...
    def run_test(self):
        ...
        for TxTemplate in invalid_txs.iter_all_templates():
            ...
            # a different hash in the test client than on umkoind, resulting
        ...
        # Extend the b26 chain to make sure umkoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure umkoind isn't accepting b28
        ...
        # umkoind doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the umkoin code has custom code which does so);
