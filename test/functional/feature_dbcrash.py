...
class ChainstateWriteCrashTest(UmkoinTestFramework):
    ...
    def restart_node(self, node_index, *, expected_tip):
        ...
        while time.time() - time_start < 120 * self.options.timeout_factor:
            try:
                ...
                # If umkoind exits, then try again.  wait_for_node_exit()
                # enforces that umkoind crashed.
        ...
        for i in range(3):
            ...
            for (block_hash, block) in blocks:
                ...
                if not self.submit_block_catch_error(i, block):
                    ...
                    # wait_for_node_exit() enforces that umkoind crashed.
