...
to a hash that has been compiled into umkoind.
...
class AssumeutxoTest(UmkoinTestFramework):
    ...
    def test_invalid_snapshot_scenarios(self, valid_snapshot_path):
        ...
        cases = [
            ...
            [b"\x83", 34, "161393f07f8ad71760b3910a914f677f2cb166e5bcf5354e50d46b78c0422d15", None],  # wrong coin code VARINT
    ...
    def test_invalid_mempool_state(self, dump_output_path):
        self.log.info("Test umkoind should fail when mempool not empty.")
        node=self.nodes[2]
    ...
    def test_invalid_file_path(self):
        self.log.info("Test umkoind should fail when file path is invalid.")
        node = self.nodes[0]
    ...
    def test_snapshot_with_less_work(self, dump_output_path):
        self.log.info("Test umkoind should fail when snapshot has less accumulated work than this node.")
        node = self.nodes[0]
