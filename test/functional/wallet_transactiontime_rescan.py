    ...
    def run_test(self):
        ...
        if not self.options.descriptors:
            ...
            with concurrent.futures.ThreadPoolExecutor(max_workers=1) as thread:
                with minernode.assert_debug_log(expected_msgs=["Rescan started from block 0x60b48405c3efa2bd7aa6a8bc206e3369e58d15f60cba7a915769e9669758cb6d... (slow variant inspecting all blocks)"], timeout=5):
