...
class TransactionTimeRescanTest(UmkoinTestFramework):
    ...
    def run_test(self):
        ...
        # send 10 umk to user's first watch-only address
        self.log.info('Send 10 umk to user')
        ...
        # send 5 umk to our second watch-only address
        self.log.info('Send 5 umk to user')
        ...
        # send 1 umk to our third watch-only address
        self.log.info('Send 1 umk to user')
        ...
        if not self.options.descriptors:
            ...
            with minernode.assert_debug_log(expected_msgs=[f'Rescan started from block 0x60b48405c3efa2bd7aa6a8bc206e3369e58d15f60cba7a915769e9669758cb6d... (slow variant inspecting all blocks)'], timeout=5):
                t.start()
