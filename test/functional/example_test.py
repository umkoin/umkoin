...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the UmkoinTestFramework
    pass


class ExampleTest(UmkoinTestFramework):
    # Each functional test is a subclass of the UmkoinTestFramework class.
    ...
    def custom_method(self):
        ...
        UmkoinTestFramework class so other tests can use it."""
