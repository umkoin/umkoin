...
"""Umkoin test framework primitive and message structures
...
COIN = 100000000  # 1 umk in satoshis
...
class CBlockLocator:
    ...
    def serialize(self):
        r = b""
        r += (0).to_bytes(4, "little", signed=True)  # Umkoin Core ignores the version field. Set it to 0.
...
class msg_version:
    ...
    def deserialize(self, f):
        ...
        # But, unconditionally check it to match behaviour in umkoind
