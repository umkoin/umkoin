...
class TestShell:
    """Wrapper Class for UmkoinTestFramework.

    The TestShell class extends the UmkoinTestFramework
    ...
    class __TestShell(UmkoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by UmkoinTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # UmkoinTestFramework instances are supposed to be constructed with the path
