...
class TestNode():
    ...
    def wait_for_rpc_connection(self, *, wait_for_import=True):
        ...
        self._raise_assertion_error(f"Unable to connect to umkoind after {self.rpc_timeout}s (ignored errors: {str(dict(suppressed_errors))}, latest error: {latest_error})")
