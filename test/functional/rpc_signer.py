...
Verify that a umkoind node can use an external signer command.
...
class RPCSignerTest(UmkoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart umkoind with -signer=<cmd>',
