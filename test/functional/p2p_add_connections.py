...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The umkoind node closes feeler connections as soon as a version
...
class P2PAddConnections(UmkoinTestFramework):
    ...
    def run_test(self):
        ...
        # umkoind behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that umkoind sends its own version prior to processing
