...
class P2PPrivateBroadcast(UmkoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-32601, "Private broadcast is not enabled. Ensure you're running Umkoin Core with -privatebroadcast=1.",
        ...
        self.restart_node(0, extra_args=[
            ...
            # Umkoin Core to start, hoping/assuming that the location of the Tor proxy
