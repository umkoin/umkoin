...
"""Verify that starting umkoin with -h works as expected."""

from test_framework.test_framework import UmkoinTestFramework
from test_framework.util import assert_equal

class HelpTest(UmkoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start umkoin with -h for help text")
        ...
        self.log.info("Start umkoin with -version for version information")
        ...
        self.log.info("Start umkoind with -fakearg to make sure it does not start")
