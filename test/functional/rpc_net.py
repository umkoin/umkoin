...
def seed_addrman(node):
    ...
    """
    node.addpeeraddress(address="1.2.3.4", tried=True, port=6333)
    node.addpeeraddress(address="2.0.0.0", port=6333)
    node.addpeeraddress(address="1233:3432:2434:2343:3234:2345:6546:4534", tried=True, port=6333)
    node.addpeeraddress(address="2803:0:1234:abcd::1", port=45324)
    node.addpeeraddress(address="fc00:1:2:3:4:5:6:7", port=6333)
    node.addpeeraddress(address="klfchu53kxun6zx5.onion", tried=True, port=6333)
    node.addpeeraddress(address="nrfj6inpyf73gpkyool35hcmne5zwfmse3jl3aw23vk7chdemalyaqad.onion", port=45324, tried=True)
    node.addpeeraddress(address="c4gfnttsuwqomiygupdqqqyy5y5emnk5c73hrfvatri67prd7vyq.b32.i2p", port=6333)
