This directory contains integration tests that test umkoind and its
...
interfaces.
- [util](/test/util) which tests the umkoin utilities, currently only
umkoin-tx.
...
```
test/get_previous_releases.py -b v0.20.1 v0.19.1
```
...
Util tests can be run locally by running `test/util/umkoin-util-test.py`.
