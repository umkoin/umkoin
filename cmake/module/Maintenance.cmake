...
function(add_macos_deploy_target)
  if(CMAKE_SYSTEM_NAME STREQUAL "Darwin" AND TARGET umkoin-qt)
    ...
    add_custom_command(
      ...
      COMMAND ${CMAKE_COMMAND} --install ${PROJECT_BINARY_DIR} --config $<CONFIG> --component umkoin-qt --prefix ${macos_app}/Contents/MacOS --strip
    ...
    set(macos_zip "umkoin-macos-app")
    if(CMAKE_HOST_APPLE)
      add_custom_command(
